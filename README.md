...
変更履歴
2026年2月6日 - DropboxからGithubに移動しました。
2025年4月2日 - スクロールとズームをLogicと同じようにし、囲みズームや時間選択などのマウスコマンドを追加しました（Reaper特有の環境に合わせて、オリジナルマウスコマンドの「⌘⌥[コマンドとオプション] + ドラッグ」でアイテムを作れるようにしました）。クリエイティブコモンズを追加しました。
2025年3月31日 - 公開。
